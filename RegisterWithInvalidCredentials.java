...
public class RegisterWithInvalidCredentials extends BaseTestClass {
    ...
    public void registerWithInvalidEmailAddress() {
        ...
        emailField.click();
        emailField.sendKeys("11cornelilieyahoo.com");
        ...
        WebElement errorMessage = driver.findElement(By.xpath("//div[contains(text(), 'Request')]"));
        Assert.assertEquals("The message is not displayed", "Request failed with status code 500", errorMessage.getText());
